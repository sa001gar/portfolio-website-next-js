...
import { ArrowRight, Code, Briefcase, FileText, User, Mail } from "lucide-react"
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-terminal-green/80 max-w-2xl">
              Software engineer with expertise in full stack development, machine learning, and cybersecurity. Building
        ...
        <section>
          <TerminalWindow title="sagar@kundu:~/portfolio">
              ...
              output={
                <div className="space-y-2">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Full Stack Web Development (Next.js, React, Django, Node.js)</li>
            ...
            <TerminalCommand
              ...
              output={
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  <div>
                    <p className="text-terminal-bright">Frontend:</p>
                  ...
                  <div>
                    <p className="text-terminal-bright">Backend:</p>
                    <ul className="text-sm">
                      <li>Node.js</li>
                      <li>Django</li>
                      <li>FastAPI</li>
                  ...
                  <div>
                    <p className="text-terminal-bright">DevOps:</p>
                    <ul className="text-sm">
                      <li>Docker</li>
                      <li>AWS/Azure</li>
                      <li>CI/CD</li>
            ...
            <TerminalCommand
              ...
              output={
                <div className="space-y-2">
                  <p className="text-terminal-bright font-bold">AI-Powered Code Analyzer</p>
                  <p>
                    A machine learning tool that analyzes code repositories to identify security vulnerabilities, code
                    quality issues, and performance bottlenecks. Built with Python, TensorFlow, and React.
                  </p>
                  <p className="text-terminal-green/70 text-sm">
                    →{" "}
                    <Link href="/projects/code-analyzer" className="underline hover:text-terminal-bright">
          ...
          <Link href="/projects" className="group">
            <div className="border border-terminal-green/20 rounded-md p-4 hover:border-terminal-green/50 hover:bg-terminal-green/5 transition-all duration-300">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-medium text-terminal-bright">Projects</h3>
              </div>
              <p className="text-terminal-green/80 text-sm mb-2">
                Explore my portfolio of web applications, ML models, and open-source contributions.
              </p>
          ...
          <Link href="/experience" className="group">
            <div className="border border-terminal-green/20 rounded-md p-4 hover:border-terminal-green/50 hover:bg-terminal-green/5 transition-all duration-300">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-medium text-terminal-bright">Experience</h3>
              </div>
              <p className="text-terminal-green/80 text-sm mb-2">
                My professional journey, skills, and achievements in software development.
              </p>
              <span className="text-terminal-green text-xs group-hover:text-terminal-bright transition-colors">
                View experience →
              </span>
          ...
          <Link href="/blog" className="group">
            <div className="border border-terminal-green/20 rounded-md p-4 hover:border-terminal-green/50 hover:bg-terminal-green/5 transition-all duration-300">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-medium text-terminal-bright">Blog</h3>
              </div>
              <p className="text-terminal-green/80 text-sm mb-2">
          ...
          <Link href="/about" className="group">
            <div className="border border-terminal-green/20 rounded-md p-4 hover:border-terminal-green/50 hover:bg-terminal-green/5 transition-all duration-300">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-medium text-terminal-bright">About</h3>
              </div>
              <p className="text-terminal-green/80 text-sm mb-2">
                Learn more about my background, interests, and technical expertise.
              </p>
              <span className="text-terminal-green text-xs group-hover:text-terminal-bright transition-colors">
                About me →
              </span>
          ...
          <Link href="/contact" className="group">
            <div className="border border-terminal-green/20 rounded-md p-4 hover:border-terminal-green/50 hover:bg-terminal-green/5 transition-all duration-300">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-medium text-terminal-bright">Contact</h3>
              </div>
              <p className="text-terminal-green/80 text-sm mb-2">
